/* Lab Program 9: Program to fill any given polygon using scan-line area filling algorithm. (Use appropriate data structures.)*/
...
{
if(le[s]<=re[s])
for(i=(int)le[s];i<(int)re[s];i++)
draw_pixel(i,s,BLACK);
}
}
